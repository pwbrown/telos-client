...
class Log{
    ...
    setWatchers(watchers){
        if(tc('String', watchers) && watchers !== ''){
            ...
            if(watchers.indexOf('error') !== -1 || watchers.indexOf('errors') !== -1)
                this.__showError = true;
            if(watchers.indexOf('trace') !== -1 || watchers.indexOf('stack') !== -1)
                this.__showTrace = true;
            if(watchers.indexOf('input') !== -1 || watchers.indexOf('in') !== -1)
                this.__showIn = true;
            if(watchers.indexOf('output') !== -1 || watchers.indexOf('out') !== -1)
                this.__showOut = true;
